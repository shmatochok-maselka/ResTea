...
import {MainPageService} from "../config/main-page.service";
...
export class MainPageComponent implements OnInit {
  ...
  ngOnInit(): void {
    this._mainPageService.getMainPage().subscribe(x=>{
      x.products.forEach((el:Product)=>this.items.push(el))
      x.blogPosts.forEach((el:BlogPost)=>this.posts.push(el))
    })
  }
